// Google Apps Script for YesGrant Application - CORRECTED VERSION
// This fixes the setHeader error and properly handles CORS
...
function getSuccessStories() {
  try {
    ...
    const stories = rows.map(row => {
      ...
      return story;
    }).filter(story => story.Status === 'Active'); // Only return active stories
